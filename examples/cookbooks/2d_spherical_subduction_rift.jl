# Cookbook: "2D Spherical Subduction-Rift"
# https://gwb.readthedocs.io/en/latest/user_manual/cookbooks/2d_spherical_subduction_rift/2d_spherical_subduction_rift.html
#
# The spherical-coordinate analog of `2d_cartesian_subduction_rift.jl`: same
# geometry and layering, but coordinates are now (longitude, latitude) in
# degrees instead of (x, y) in meters, with `depth method = "begin segment"`.
...
write_wb(world, joinpath(@__DIR__, "2d_spherical_subduction_rift.wb"))
...
write_grid_config(cfg, joinpath(@__DIR__, "2d_spherical_subduction_rift.grid"))
